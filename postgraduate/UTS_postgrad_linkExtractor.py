...
# MAIN ROUTINE
courses_page_url = 'https://www.uts.edu.au/future-students/find-a-course/search?search=postgraduate#panel-postgraduate'
...
# SAVE TO FILE
course_links_file_path = os.getcwd().replace('\\', '/') + '/UTS_postgrad_links.txt'
